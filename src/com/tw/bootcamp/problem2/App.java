...
public class App {
  static void main() {
    ...
    System.out.println("Chance of Getting Only Tails with two coins:" + Chance.of(0.25));
    System.out.println("Chance of Getting Three on one Dice:" + Chance.of(0.166));
    System.out.println("Chance of Getting AtLeast ne Tail with two coins:" + Chance.of(0.75));
  }
}
